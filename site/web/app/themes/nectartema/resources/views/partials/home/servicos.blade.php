<section id="servicos" class="section-home reveal-on-scroll delay-300 container gap-8 mt-8 mb-8 lg:mt-10">
    ...
    <div class="flex flex-col md:flex-row">
        <div class="servicos-info">
            ...
            <h3 class="md:min-h-28">Consultoria para o Desenvolvimento da produção de mel</h3>
        ...
        <div class="servicos-info">
            ...
            <h3 class="md:min-h-28">Diagnósticos Socioambientais
                com Comunidades</h3>
        ...
        <div class="servicos-info">
            ...
            <h3 class="md:min-h-28">Implantação de
