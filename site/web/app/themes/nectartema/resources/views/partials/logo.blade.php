<a class="brand relative" href="{{ home_url('/') }}">
    <img  width="302" height="84" id="logo" class="hover:scale-105 transition duration-300 ease-in-out" alt="Logo da Néctar da Amazônia" src="{{ Vite::asset('resources/images/logonectarnovo.webp') }}">
