<div x-data="{ mobileOpen: false }" class="relative" x-cloak>
  ...
  <div class="hidden lg:flex items-center space-x-6 text-xl lg:text-lg font-heading">
  ...
  >
    <svg x-show="!mobileOpen" class="absolute inset-0 w-full h-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" color="var(--color-primary)" />
    </svg>
    <svg x-show="mobileOpen" class="absolute inset-0 w-full h-full" fill="none" viewBox="0 0 24 24" stroke="var(--color-primary)">
